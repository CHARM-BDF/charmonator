...
export async function doTranscriptExtension(input, res = null) {
  ...
  try {
    const {
      ...
      num_attempts_to_correct_schema = config.num_attempts_to_correct_schema,
      options
    } = body;
    ...
    const invocationOptions = {
      ...
      num_schema_repair_max_attempts: num_schema_repair_max_attempts || config.num_schema_repair_max_attempts,
      abort_signal: abortController.signal
    };

    const numAttempts =
      1 + (invocationOptions.num_schema_repair_max_attempts);
