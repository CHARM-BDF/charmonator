...
- **Parse-preservation note:** Some routes preserve malformed structured-output replies by storing an object such as `{ "__json_parse_error": "...", "raw_text": "..." }` instead of discarding the raw model output.
